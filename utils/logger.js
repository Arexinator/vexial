...
module.exports = class Logger {
	static log (content, type = "info") {
        ...
        case "button": {
            return console.log(`${chalk.hex('#1FAC64')(`BUTTONS     ${chalk.hex('#1FAC64')(`[${date}]`)} `)} ${chalk.hex('#1FAC64')(content)}`);
        }
        case "menu": {
            return console.log(`${chalk.hex('#1FAC64')(`MENUS     ${chalk.hex('#1FAC64')(`[${date}]`)} `)} ${chalk.hex('#1FAC64')(content)}`);
        }
		default: throw new TypeError("Logger type must be either info, warn, error, cmd, button, menu, event or success.");
		}
	}
};